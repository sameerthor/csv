        ...
        csvData.pipe(csvParser({ headers: true }))
            ...
            .on('end', function () {
                ...
                if (offset == 1) {
                    ...
                    parsedData.splice(1000, 173749)  // Change this to get more store
                } else {
                    parsedData.splice(0, (offset - 1) * 1000)
                    parsedData.splice(1000, parsedData.length-1)  // Change this to get more store
                }
                test(res, offset);
